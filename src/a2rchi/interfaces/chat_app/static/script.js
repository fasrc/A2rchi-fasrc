...
const loadDataFromLocalstorage = () => {
    ...
    const defaultText = `<div class="default-text">
                            <h1>A2rchi</h1>
                            <p>Start a conversation and explore the power of A2rchi, specially trained on FASRC (demo).<br> 
...
const getChatResponse = async (incomingChatDiv, isRefresh=false) => {
    const API_URL = "http://127.0.0.1:7682/api/get_chat_response";
...
const likeResponse = (likeBtn) => {
    ...
    const API_URL = "http://127.0.0.1:7682/api/like";
...
const dislikeResponse = (dislikeBtn) => {
    ...
    const API_URL = "http://127.0.0.1:7682/api/dislike";
